...
def analyze(phoneme1, phoneme2, words):
	...
	if overlap(env1, env2):
		if meaning():
			print('\n[' + phoneme1 + '] and [' + phoneme2 + '] are in free variation.')
		else:
			print('\n[' + phoneme1 + '] and [' + phoneme2 + '] are in contrastive distribution.')
			print('The two phonemes are allophones of different phonemes.')
	else:
		print('\n[' + phoneme1 + '] and [' + phoneme2 + '] are in complementary distribution.')
